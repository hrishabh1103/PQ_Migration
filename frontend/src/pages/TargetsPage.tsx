...
export const TargetsPage: React.FC<TargetsPageProps> = ({ onNavigateScans }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        title="Authorized Scan Targets"
        description="Explicitly approved target scopes and endpoints authorized for discovery scans."
        icon={Target}
        breadcrumbs={[{ label: 'Discovery' }, { label: 'Targets' }]}
        actions={
          <button
